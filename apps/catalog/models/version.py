...
class Version(BaseModel):
    ...
    product = models.ForeignKey('Product', on_delete=models.DO_NOTHING, verbose_name=_('Продукт'), related_name='versions')
...
#         previous_version = Version.objects.filter(product__pk=instance.product.pk).latest('number')
